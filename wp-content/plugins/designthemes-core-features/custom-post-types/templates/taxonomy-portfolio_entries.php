<?php get_header(); 
  $page_layout = redart_option('pageoptions','portfolio-archives-page-layout');
  ...
  if ( $show_sidebar ):
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
      ...
      $post_layout = redart_option('pageoptions','portfolio-archives-post-layout');
      $post_layout = isset( $post_layout ) ? $post_layout : 'one-half-column';

      $post_style = redart_option('pageoptions','portfolio-archives-post-style');
      $post_style = isset( $post_style ) ? $post_style : 'type1';

      $allow_space = redart_option('pageoptions','portfolio-allow-grid-space');
            ...
            #setting up images
              ...
              if( has_post_thumbnail() ){
                ...
                if( $post_thumb ) {
                  ...
                  $image = $popup = 'http'.redart_ssl().'://placehold.it/1170X902.jpg&text='.get_the_title($the_id);  
                } 
              }elseif( $items ) {
                $image = $image;
                $popup = $popup;
                ...
                <div class="image-overlay">
                    ...
                    <?php elseif( $post_style == "type1" || $post_style == "type2" || $post_style == "type5"):?>
                            ...
                            <div class="image-overlay-details">
                                <h2><a href="<?php the_permalink();?>" title="<?php printf( esc_attr__('Permalink to %s','dtthemes-core'), the_title_attribute('echo=0'));?>"><?php 
                                    the_title();?></a></h2><?php
