...
function dt_sc_domain_box_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Domain item", 'dtthemes-core' ),
		"base" => "dt_sc_domain_box",
		"icon" => "dt_sc_domains_wrapper",
		"category" => DT_VC_CATEGORY,
		'as_child' => array( 'only' => 'dt_sc_domains_wrapper' ),
		'description' => esc_html__( 'Add domain item', 'dtthemes-core' ),
		"params" => array(
			...
			array(
				'type' => 'textfield',
				'param_name' => 'domain',
				'heading' => esc_html__( 'Domain', 'dtthemes-core' ),
				'description' => esc_html__( 'Enter domain eg: .com / .net', 'dtthemes-core' ),
				'admin_label' => true
			),			
			...
			array(
				...
				'description' => esc_html__( 'Enter icon class eg: (pe-icon pe-check or fa fa-home)', 'dtthemes-core' )
			),
			...
			array(
				...
				'description' => esc_html__( 'Enter price eg: $12.85', 'dtthemes-core' ),
				'admin_label' => true
			),
