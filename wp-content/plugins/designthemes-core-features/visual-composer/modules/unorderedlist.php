...
function dt_sc_fancy_ul_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Fancy Unordered List", 'dtthemes-core' ),
		"base" => "dt_sc_fancy_ul",
		"icon" => "dt_sc_fancy_ul",
		...
		"params" => array(
			...
			array(
				...
				'value' => array(
					...
					'Tag' => 'tag', 'Thumbs Down' => 'thumbs-down', 'Thumbs Up' => 'thumbs-up', 'Tick' => 'tick', 'Time' => 'time', 'Trash' => 'trash', 'Twitter' => 'twitter', 'Warning' => 'warning'					
				)
			),
			...
			array(
				'type' => 'dropdown',
				'admin_label' => true,
				'heading' => esc_html__('Variation', 'dtthemes-core'),
			...
			array(
				'type' => 'textarea_html',
				'heading' => esc_html__('Add Unordered List','dtthemes-core'),
				'param_name' => 'content',
