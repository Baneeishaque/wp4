...
function dt_sc_toggle_vc_map() {
	vc_map( array(
		"name" => esc_html__( "Toggle", 'dtthemes-core' ),
		"base" => "dt_sc_toggle",
		"category" => DT_VC_CATEGORY,
		'as_child' => array( 'only' => 'dt_sc_toggle_group' ),
		'description' => esc_html__( 'Section for Toggles', 'dtthemes-core' ),
		"params" => array(
			...
			array(
				...
				'heading' => esc_html__( 'Title', 'dtthemes-core' ),
      			'admin_label' => true,
				'description' => esc_html__( 'Enter section title (Note: you can leave it empty)', 'dtthemes-core' )
			),
