...
function dt_sc_align_vc_map() {
	...
	vc_map( array( 
		...
		"name" => esc_html__( "Content Alignment", 'dtthemes-core' ),
		"base" => "dt_sc_align",
		"icon" => "dt_sc_align",
		...
		"params" => array(
			...
			array(
				'type' => 'dropdown',
				'admin_label' => true,
				'heading' => esc_html__('Alignment', 'dtthemes-core'),
				'param_name' => 'align',
			...
			array(
				'type' => 'css_editor',
				'heading' => esc_html__( 'Design', 'dtthemes-core' ),
				'param_name' => 'css',
				'group' => esc_html__( 'CSS', 'dtthemes-core' ),
			),			
		)
	) );
}?>