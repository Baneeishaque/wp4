...
function dt_sc_recent_posts_by_cat_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Recent Posts From Category", 'dtthemes-core' ),
		"base" => "dt_sc_recent_cat_post",
		"icon" => "dt_sc_recent_cat_post",
		"category" => DT_VC_CATEGORY,
		"description" => esc_html__("Show recent posts from given categories",'dtthemes-core'),
		"params" => array(

			// Post Count
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Category ID', 'dtthemes-core' ),
				'param_name' => 'category',
				'description' => esc_html__( 'Enter category ID', 'dtthemes-core' ),
				'admin_label' => true
			),
