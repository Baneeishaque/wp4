...
function dt_sc_tabs_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Tabs", 'dtthemes-core' ),
		"base" => "dt_sc_tabs",
		"icon" => "dt_sc_tabs",
		...
		'params' => array(
			...
			array(
				...
				'description' => esc_html__( 'Select tabs type display', 'dtthemes-core' )
			),
			...
			array(
				...
				'description' => esc_html__( 'Select tabs display style', 'dtthemes-core' )
			),
		...
		'default_content' =>'[dt_sc_tab title="' . esc_html__( 'Tab 1', 'dtthemes-core' ) . '" tab_id="' . $tab_id_1 . '"][/dt_sc_tab]
			[dt_sc_tab title="' . esc_html__( 'Tab 2', 'dtthemes-core' ) . '" tab_id="' . $tab_id_2 . '"][/dt_sc_tab]',
		'js_view' => 'DTTabsView'
	) );
