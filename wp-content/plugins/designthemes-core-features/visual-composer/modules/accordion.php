...
function dt_sc_accordion_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( "Accordions", 'dtthemes-core' ),
		"base" => "dt_sc_accordion",
		"category" => DT_VC_CATEGORY,
		"show_settings_on_create" => false,
		"is_container" => true,
		"icon" => "dt_sc_accordion",
		'description' => esc_html__( 'Collapsible content panels', 'dtthemes-core' ),
		"params" => array(
			...
			array(
				...
				'description' => esc_html__( 'Select accordion display style', 'dtthemes-core' )
			),
			...
			array(
				...
				'description' => esc_html__( 'Select standard accordion display type', 'dtthemes-core' ),
			...
			array(
				...
				'heading' => esc_html__( 'Type', 'dtthemes-core' ),
				'description' => esc_html__( 'Select framed accordion display type', 'dtthemes-core' ),
		...
		'custom_markup' => '<div class="wpb_accordion_holder wpb_holder clearfix vc_container_for_children">%content%</div>
			<div class="tab_controls">
				<a class="add_tab" title="' . esc_attr__( 'Add section', 'dtthemes-core' ) . '">
				<span class="vc_icon"></span> <span class="tab-label">' . esc_html__( 'Add section', 'dtthemes-core' ) . '</span></a>
			</div>',
		'default_content' => '[dt_sc_accordion_tab title="' . esc_html__( 'Section 1', 'dtthemes-core' ) . '"][/dt_sc_accordion_tab]
			[dt_sc_accordion_tab title="' . esc_html__( 'Section 2', 'dtthemes-core' ) . '"][/dt_sc_accordion_tab]'			
	) );
