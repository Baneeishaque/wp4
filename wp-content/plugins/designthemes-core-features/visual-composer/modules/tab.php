...
function dt_sc_tab_vc_map() {
	...
	vc_map( array(
		'name' => esc_html__( 'Tab', 'dtthemes-core' ),
		'base' => 'dt_sc_tab',
		...
		'params' => array(
			...
			array(
				'type' => 'tab_id',
				'heading' => esc_html__( 'Tab ID', 'dtthemes-core' ),
				'param_name' => "tab_id"
			),
			...
			array(
				...
				'param_name' => 'title',
				'description' => esc_html__( 'Enter title of tab', 'dtthemes-core' )
			),
			...
			# Custom icon Class
      		array(
      			"type" => "textfield",
      			"heading" => esc_html__( "Icon class name", 'dtthemes-core' ),
