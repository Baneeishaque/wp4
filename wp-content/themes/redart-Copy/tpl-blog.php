...
get_header();
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
                        ...
                        <?php if( $post_style == "entry-date-left"): ?>
                                ...
                                <div class="entry-details">
                                    ...
                                    <?php if( array_key_exists('blog-post-excerpt',$tpl_default_settings) && array_key_exists('blog-post-excerpt-length',$tpl_default_settings) ):?>
                                    		<div class="entry-body"><?php echo redart_excerpt($tpl_default_settings['blog-post-excerpt-length']);?></div>
                                   <?php endif;?>
                                   ...
                                   <?php if( array_key_exists('enable-blog-readmore',$tpl_default_settings) ):
											...
											$sc = str_replace("[dt_sc_button",'[dt_sc_button link="url:'.$link.'" ',$sc);
											$sc = do_shortcode($sc);
											echo !empty( $sc ) ? $sc : '';
        ...
        <!-- **Pagination** -->
        <div class="pagination blog-pagination"><?php echo redart_pagination($the_query); ?></div><!-- **Pagination** -->
        <!-- Blog Template Ends -->
