...
<?php while ( have_posts() ) : the_post(); ?>
	<div class="tribe-events-organizer">
			<p class="tribe-events-back">
				<a href="<?php echo esc_url( tribe_get_events_link() ); ?>" rel="bookmark"><?php printf( __( '&larr; Back to %s', 'redart' ), tribe_get_event_label_plural() ); ?></a>
			</p>
		...
		<div class="tribe-events-organizer-meta tribe-clearfix">
				...
				<h2 class="entry-title tribe-organizer-name"><?php echo tribe_get_organizer( $organizer_id ); ?></h2>
