...
<!-- Event Image -->
<?php echo tribe_event_featured_image( null, 'event-list' ) ?>
...
<div class="tribe-events-list-event-detail">
    ...
    <div class="tribe-events-map-event-description tribe-events-content description entry-summary">
        ...
        <?php endif; ?>        
        <a href="<?php echo esc_url( tribe_get_event_link() ); ?>" class="tribe-events-read-more" rel="bookmark"><?php esc_html_e( 'Find out more', 'redart' ) ?> &raquo;</a>
