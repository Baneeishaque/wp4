                ...
                <div class="box-content dttheme-import">
                    ...
                    <div class="column two-third last">
                    	<select name="demo" class="demo medium dt-chosen-select">
                            ...
                            <option data-link="http://redart.dttheme.com/" value="redart"><?php esc_html_e('Redart', 'redart');?></option>
                            <option data-link="http://redart.dttheme.com/aquarium/" value="aquarium"><?php esc_html_e('Aquarium', 'redart');?></option>
                            <option data-link="http://redart.dttheme.com/bike/" value="bike"><?php esc_html_e('Bike', 'redart');?></option>
                            <option data-link="http://redart.dttheme.com/fitness/" value="fitness"><?php esc_html_e('Fitness', 'redart');?></option>
                            <option data-link="http://redart.dttheme.com/model/" value="model"><?php esc_html_e('Model', 'redart');?></option>
                            <option data-link="http://redart.dttheme.com/wine/" value="wine"><?php esc_html_e('Wine', 'redart');?></option>
                        </select>
                        <a class="lnk-onlinedemo" href="http://redart.dttheme.com/" target="_blank"><?php esc_html_e('Online Demo', 'redart');?></a>
                    </div>
                    <div class="hr_invisible"> </div>
