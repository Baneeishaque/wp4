            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">
                    ...
                    <div class="column two-third last">
                        ...
                        <p class="note"><?php esc_html_e('Do not use characters not allowed in links. Use, eg. portfolio-item <br> <b>After change go to Settings > Permalinks and click Save changes.</b>', 'redart');?></p>
                    </div>
                    <div class="hr"></div>
                    ...
                    <div class="column two-third last">
                        ...
                        <p class="note"><?php esc_html_e('Do not use characters not allowed in links. Use, eg. portfolio-types <br> <b>After change go to Settings > Permalinks and click Save changes.</b>', 'redart');?></p>
                    </div>
				</div>
            </div><!-- .bpanel-box end -->
