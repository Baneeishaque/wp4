    ...
    <div class="bpanel-main-content">
        ...
        <div id="tab3" class="tab-content">
            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">
                    <!--<h6><?php #esc_html_e('Static CSS', 'redart');?></h6>
                    <div class="column one-fifth">
                          <?php #$checked = ( "true" ==  redart_option('general','enable-staticcss') ) ? ' checked="checked"' : ''; ?>
                          <?php #$switchclass = ( "true" ==  redart_option('general','enable-staticcss') ) ? 'checkbox-switch-on' :'checkbox-switch-off'; ?>
                          <div data-for="dttheme-enable-staticcss" class="checkbox-switch <?php #echo esc_attr($switchclass);?>"></div>
                          <input class="hidden" id="dttheme-enable-staticcss" name="dttheme[general][enable-staticcss]" type="checkbox" value="true" <?php #echo redart_wp_kses($checked);?> />
                    </div>
                    <div class="column four-fifth last">
                          <p class="note"><?php #esc_html_e('YES! to use Static CSS files instead of Theme Options.', 'redart');?></p>
                    </div>
                    <div class="hr"></div>-->
