<?php
	#Page Meta Box
	add_action("add_meta_boxes", "redart_page_metabox");
	add_action('save_post','redart_page_meta_save');

	if( !function_exists('redart_page_metabox') ) {
		function redart_page_metabox(){
			add_meta_box("page-template-slider-meta-container", esc_html__('Slider Options', 'redart'), "redart_page_slider_settings", "page", "normal", "default");
			add_meta_box("page-template-meta-container", esc_html__('Default page Options', 'redart'), "redart_page_settings", "page", "normal", "default");
		}
	}

	#Slider Meta Box
	if( !function_exists('redart_page_slider_settings') ) {
		function redart_page_slider_settings($args){
			global $post;
			...
			<div class="custom-box">
				<div class="column one-sixth">
					<label><?php esc_html_e('Show Slider','redart');?> </label>
				</div>
				<div class="column four-sixth last">
					...
					<input id="dttheme-show-slider" class="hidden" type="checkbox" name="dttheme-show-slider" value="true" <?php echo redart_wp_kses($checked);?>/>
					<p class="note"> <?php esc_html_e('YES! to show slider on this page.','redart');?> </p>
				</div>
			</div><!-- Show Slider End-->
			...
			<div class="custom-box">
				<div class="column one-sixth">
					<label><?php esc_html_e('Choose Slider','redart');?></label>
				</div>
				<div class="column four-sixth last">
					<?php $slider_types = array( '' => esc_html__('Select','redart'),
												 'layerslider' => esc_html__('Layer Slider','redart'),
												 'revolutionslider' => esc_html__('Revolution Responsive','redart'),
												 'customslider' => esc_html__('Custom Slider Shortcode', 'redart'));
						  ...
						  endforeach;
						 echo "</select>";?>
				<p class="note"> <?php esc_html_e("Select a slider for your page",'redart');?> </p>
				</div>
			...
			<div id="slider-conainer"><?php
				...
				<!-- Layered Slider -->
				<div id="layerslider" class="custom-box" <?php echo redart_wp_kses($layerslider);?>>
					<h3><?php esc_html_e('Layer Slider','redart');?></h3><?php
					# Check layer slider active
					if(redart_is_plugin_active('LayerSlider/layerslider.php')):
						...
						if(!empty($sliders)):
							...
							echo '			<label>'.esc_html__('Select LayerSlider','redart').'</label>';
							echo '		</div>';
							echo ' 		<div class="column two-sixth">';
							echo '			<select name="layerslider_id" class="dt-chosen-select">';
							echo '				<option value="0">'.esc_html__("Select Slider",'redart').'</option>';
												...
												endforeach;
							echo '			</select>';
							echo '			<p class="note">'.esc_html__("Choose Which LayerSlider you would like to use..",'redart').'</p>';
							echo '		</div>';
							echo '	</div>';
							echo '</div>';
						else:
							echo '<p id="j-no-images-container">'.esc_html__('Please add at leat one layer slider','redart').'</p>';
						endif;
					else:
						echo '<p id="j-no-images-container">'.esc_html__('Please activate Layered Slider','redart').'</p>';
					endif; ?>
				</div><!-- Layered Slider End-->
	
				<!-- Revolution Slider -->
				<div id="revolutionslider" class="custom-box" <?php echo redart_wp_kses($revolutionslider);?>>
					<h3><?php esc_html_e('Revolution Slider','redart');?></h3><?php
					# Check revolution slider active
					if(redart_is_plugin_active('revslider/revslider.php')):
						$sld = new RevSlider();
						...
						if(!empty($sliders)):
							...
							echo '	<div class="bpanel-option-set">';
							echo ' <div class="column one-sixth">';
							echo '	<label>'.esc_html__('Select Slider','redart').'</label>';
							echo ' 	</div>';
							...
							echo '	<select name="revolutionslider_id" class="dt-chosen-select">';
								...
								endforeach;
							echo '	</select>';
							echo '<p class="note">'.esc_html__("Choose which Revolution slider would you like to use!",'redart').'</p>';
							echo ' 	</div>';
							echo '	</div>';
							echo '</div>';
						else:
							echo '<p id="j-no-images-container">'.esc_html__('Please add at leat one revolution slider','redart').'</p>';
						endif;
					else:
						echo '<p id="j-no-images-container">'.esc_html__('Please activate Revolution Slider , and add at least one slider.','redart').'</p>';
					endif; ?>
				</div><!-- Revolution Slider End-->
	
				<!-- Custom Slider Shortcode -->
				<div id="customslider" class="custom-box" <?php echo redart_wp_kses($customslider);?>>
					<h3><?php esc_html_e('Custom Slider','redart');?></h3>
					<div class="one-half-content">
						<div class="bpanel-option-set">
							<div class="column one-sixth">
								<label><?php esc_html_e('Shortcode', 'redart'); ?></label>
							</div>
							<div class="column three-sixth">
								...
								<p class="note"> <?php esc_html_e('Enter your custom slider shortcode.','redart');?> </p>
							</div>
						</div>
					</div>
	...
	#Page Meta Box
	if( !function_exists('redart_page_settings') ) {
		function redart_page_settings($args){
			...
			<div class="j-pagetemplate-container">
					...
					<div id="tpl-common-settings">
						...
						<div class="sub-title custom-box">
							<div class="column one-sixth"><?php esc_html_e( 'Title Background','redart');?></div>
							<div class="column five-sixth last">
								...
								<div class="one-third column last">
									<label><?php esc_html_e('Opacity','redart');?></label>
						...
						<div class="sub-title custom-box">
							...
							<div class="column five-sixth last">
								<div class="column one-third">
									<label><?php esc_html_e('Background Repeat','redart');?></label>
									...
									<p class="note"><?php esc_html_e('Select background image repeat style','redart');?></p>
								</div>
		
								<div class="column one-third">
									<label><?php esc_html_e('Background Position','redart');?></label>
									...
									<p class="note"><?php esc_html_e('Select background image position','redart');?></p>
								</div>
								...
								<?php $label = 		esc_html__('Background Color','redart');
									  ...
									  $tooltip = 	esc_html__('Select background color for sub title section','redart'); ?>
						...
						<div id="page-layout" class="custom-box">
							<div class="column one-sixth"><label><?php esc_html_e('Layout','redart');?> </label></div>
							<div class="column five-sixth last">
								...
								<p class="note"> <?php esc_html_e("You can choose a perfect layout for your page",'redart');?> </p>
							</div>
						</div> <!-- Layout End-->
						...
						<div id="widget-area-options" <?php echo redart_wp_kses($sidebar_both);?>>
							<div id="left-sidebar-container" class="page-left-sidebar" <?php echo redart_wp_kses($sidebar_left); ?>>
								...
								<div id="page-commom-sidebar" class="sidebar-section custom-box">
									<div class="column one-sixth"><label><?php esc_html_e('Show Standard Left Sidebar','redart');?></label></div>
									<div class="column five-sixth last"><?php 
										...
										<p class="note"> <?php esc_html_e('Yes! to show Standard Left Sidebar','redart');?> </p>
									 </div>
								...
								<div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
									<div class="column one-sixth"><label><?php esc_html_e('Choose Widget Area - Left Sidebar','redart');?></label></div>
									<div class="column five-sixth last"><?php
										...
										<select class="dt-chosen-select" name="dttheme[widgetareas-left][]" multiple="multiple" data-placeholder="<?php esc_attr_e('Select Widget Area', 'redart');?>"><?php
							...
							<div id="right-sidebar-container" class="page-right-sidebar" <?php echo redart_wp_kses($sidebar_right); ?>>
								...
								<div id="page-commom-sidebar" class="sidebar-section custom-box page-right-sidebar">
									<div class="column one-sixth"><label><?php esc_html_e('Show Standard Right Sidebar','redart');?></label></div>
									<div class="column five-sixth last"><?php 
										...
										<p class="note"> <?php esc_html_e('Yes! to show Standard Right Sidebar','redart');?> </p>
									 </div>
								</div><!-- Standard Sidebar Right End-->
	
								<!-- 3. Choose Widget Areas Start -->
								<div id="page-sidebars" class="sidebar-section custom-box page-widgetareas">
									<div class="column one-sixth"><label><?php esc_html_e('Choose Widget Area - Right Sidebar','redart');?></label></div>
									<div class="column five-sixth last"><?php
										...
										$widgets = redart_option('widgetarea','custom');?>
										<select class="dt-chosen-select" name="dttheme[widgetareas-right][]" multiple="multiple" data-placeholder="<?php esc_attr_e('Select Widget Area', 'redart');?>"><?php
											echo "<option value=''></option>";
											foreach ( $widgets as $widget ) :
												$id = mb_convert_case($widget, MB_CASE_LOWER, "UTF-8");
												$id = str_replace(" ", "-", $id);
					...
					<div id="tpl-onepage-settings">
						<div class="custom-box">
							<div class="column one-sixth">
								<label><?php esc_html_e('Choose Menu','redart');?></label>
							</div>
							<div class="column five-sixth last">
								...
								<p class="note"> <?php esc_html_e("Select a menu items work as one page. Note: It doesn't work for split menu.",'redart');?> </p>
							</div>
						</div>
				   ...
				   <div id="tpl-blog">
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth">                
							  <label><?php esc_html_e('Posts Layout','redart');?> </label>
						  </div>
						  <div class="column five-sixth last">
							  <ul class="dt-bpanel-layout-set">
							  <?php $posts_layout = array(	'one-column'=>	esc_html__("Single post per row.",'redart'),
															'one-half-column'=>	esc_html__("Two posts per row.",'redart'),
							  ...
							  <p class="note"> <?php esc_html_e("You can choose perfect column style for your blog posts",'redart');?> </p>
						  </div>
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth"> 
							  <label><?php esc_html_e('Post Style','redart');?></label>
						  </div>
						  <div class="column five-sixth last"> 
							  ...
							  <p class="note"> <?php esc_html_e("Select a style to show blog post",'redart');?> </p>
						  </div>
					  </div><!-- Post Style End-->
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth">
							  <label><?php esc_html_e('Enable Readmore','redart');?></label>
						  </div>
						  <div class="column five-sixth last">                     
							  ...
							  <input id="dttheme-enable-blog-readmore" class="hidden" type="checkbox" name="dttheme-enable-blog-readmore" value="true" <?php echo redart_wp_kses($checked);?>/>
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth"> 
							  <label><?php esc_html_e('Read More Button','redart');?></label>
						  </div>
						  <div class="column five-sixth last">
								<?php $v = array_key_exists("blog-readmore",$tpl_default_settings) ?  $tpl_default_settings['blog-readmore'] : '[dt_sc_button size="small" style="filled" target="_blank" class="dt-sc-expand dt-sc-expand-vertical" title="Read More" /]';?>
								<textarea rows="1" cols="100%" id="dttheme-blog-readmore" name="dttheme-blog-readmore"><?php echo esc_attr($v);?></textarea>
							  <p class="note"> <?php esc_html_e("Enter button shortcode",'redart');?> </p>
						  </div>
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth">
							  <label><?php esc_html_e('Allow Excerpt','redart');?></label>
						  </div>
						  <div class="column five-sixth last">                     
							  ...
							  <input id="dttheme-blog-post-excerpt" class="hidden" type="checkbox" name="dttheme-blog-post-excerpt" value="true" <?php echo redart_wp_kses($checked);?>/>
							  <p class="note"> <?php esc_html_e('YES! to enable excerpt','redart');?> </p>
						  </div>
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth">
							  <label><?php esc_html_e('Excerpt Length','redart');?></label>
						  </div>
						  <div class="column five-sixth last">
							  ...
							  <p class="note"> <?php esc_html_e("Limit! Number of characters from the content to appear on each blog post (Number Only)",'redart');?> </p>
						  </div>
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth"> 
							  <label><?php esc_html_e('Post per page','redart');?></label>
						  </div>
						  <div class="column five-sixth last"> 
							  <select name="dttheme-blog-post-per-page" class="dt-chosen-select">
								  <option value="-1"><?php esc_html_e("All",'redart');?></option>
							  ...
							  <p class="note"> <?php esc_html_e("Select number of posts per page.",'redart');?> </p>
						  </div>
					  </div><!-- Post Count End-->
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth">
							  <label><?php esc_html_e('Choose Categories','redart');?></label>
						  </div>
						  <div class="column five-sixth last"><?php
							  ...
							  <select class="dt-chosen-select" name="dttheme[blog][cats][]" multiple="multiple" data-placeholder="<?php esc_attr_e('Select Categories', 'redart');?>"><?php
								  echo "<option value=''></option>";
								  foreach ( $cats as $cat ) :
							  ...
							  <p class="note"> <?php esc_html_e("Select categories to exclude from your blog page.",'redart');?> </p>
						  </div>
					  </div><!-- Categories End-->
	
					<!-- Post Meta-->
					<div class="custom-box">
						<h3><?php esc_html_e('Post Meta Options','redart');?></h3>
						<?php $post_meta = array(
								array(
									"id"=>		"show-postformat-info",
									"label"=>	esc_html__("Show the post format info.",'redart'),
									"tooltip"=>	esc_html__("By default the post format info will display when viewing your posts. You can easily disable it here.",'redart')
								), array(
									"id"=>		"show-author-info",
									"label"=>	esc_html__("Show the Author info.",'redart'),
									"tooltip"=>	esc_html__("By default the author info will display when viewing your posts. You can easily disable it here.",'redart')
								), array(
									"id"=>		"show-date-info",
									"label"=>	esc_html__("Show the date info.",'redart'),
									"tooltip"=>	esc_html__("By default the date info will display when viewing your posts. You can easily disable it here.",'redart')
								),
								array(
									"id"=>		"show-comment-info",
									"label"=>	esc_html__("Show the comment",'redart'),
									"tooltip"=>	esc_html__("By default the comment will display when viewing your posts. You can easily disable it here.",'redart')
								),
								array(
									"id"=>		"show-category-info",
									"label"=>	esc_html__("Show the category",'redart'),
									"tooltip"=>	esc_html__("By default the category will display when viewing your posts. You can easily disable it here.",'redart')
								),
								array(
									"id"=>		"show-tag-info",
									"label"=>	esc_html__("Show the tag",'redart'),
									"tooltip"=>	esc_html__("By default the tag will display when viewing your posts. You can easily disable it here.",'redart')
								));
							$count = 1;
				   ...
				   <div id="tpl-portfolio">
					  ...
					  <div class="custom-box">
						  ...
						  <div class="column five-sixth last">
							  ...
							  <p class="note"> <?php esc_html_e("You can choose perfect column style for your portfolio items",'redart');?> </p>
						  </div>      
					  ...
					  <div class="custom-box">
						  ...
						  <div class="column five-sixth last"> 
							  <select name="dttheme-portfolio-post-style" class="dt-chosen-select">
								  ...
								  <?php	$portfolio_styles =  array( 'type1' => esc_html__('Classic','redart'), 'type2' => esc_html__('Curly','redart'), 'type3' => esc_html__('Minimal','redart'),
							  ...
							  <p class="note"> <?php esc_html_e("Select a style to show portfolio item",'redart');?> </p>
						  </div>
					  </div><!-- Post Style End-->
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth">                
							  <label><?php esc_html_e('Allow Grid Space','redart');?></label>
						  </div>
						  <div class="column five-sixth last">
							  ...
							  <input id="dttheme-portfolio-grid-space" class="hidden" type="checkbox" name="dttheme-portfolio-grid-space" value="true" <?php echo redart_wp_kses($checked);?>/>
							  <p class="note"> <?php esc_html_e('YES! to allow grid space in between portfolio item','redart');?> </p>
						  </div>
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth">                
							  <label><?php esc_html_e('Allow Filters','redart');?></label>
						  </div>
						  <div class="column five-sixth last">                       
							  ...
							  <input id="dttheme-portfolio-filter" class="hidden" type="checkbox" name="dttheme-portfolio-filter" value="true" <?php echo redart_wp_kses($checked);?>/>
							  <p class="note"> <?php esc_html_e('YES! to allow filter options for portfolio items','redart');?> </p>
						  </div>
					  </div><!-- Allow Filters -->
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth">                
							  <label><?php esc_html_e('Ajax Load More','redart');?></label>
						  </div>
						  <div class="column five-sixth last">
							  <?php $switchclass = array_key_exists("ajax-loadmore",$tpl_default_settings) ? 'checkbox-switch-on' :'checkbox-switch-off';
									$checked = array_key_exists("ajax-loadmore",$tpl_default_settings) ? ' checked="checked"' : '';?>
							  <div data-for="dttheme-portfolio-ajax-loadmore" class="checkbox-switch <?php echo esc_attr($switchclass);?>"></div>
							  <input id="dttheme-portfolio-ajax-loadmore" class="hidden" type="checkbox" name="dttheme-portfolio-ajax-loadmore" value="true" <?php echo redart_wp_kses($checked);?>/>
							  <p class="note"> <?php esc_html_e('YES! to allow ajax load more instead of pagination','redart');?> </p>
						  </div>
					  </div><!-- Ajax Load More -->
					  ...
					  <div class="custom-box">
						  <div class="column one-sixth">                
							  <label><?php esc_html_e('Allow Full Width','redart');?></label>
						  </div>
						  <div class="column five-sixth last">
							  ...
							  <input id="dttheme-portfolio-fullwidth" class="hidden" type="checkbox" name="dttheme-portfolio-fullwidth" value="true" <?php echo redart_wp_kses($checked);?>/>
							  <p class="note"> <?php esc_html_e('YES! to allow Full Width portfolio layout','redart');?> </p>
						  </div>
					  ...
					  <div class="custom-box">
						  ...
						  <div class="column five-sixth last"><?php
							  ...
							  <select class="dt-chosen-select" name="dttheme[portfolio][cats][]" multiple="multiple" data-placeholder="<?php esc_attr_e('Select Categories', 'redart');?>"><?php
								  echo "<option value=''></option>";
								  foreach ( $cats as $cat ) :
									  $id = esc_attr ( $cat->term_id );
									  $title = esc_html ( $cat->name );
							  ...
							  <p class="note"> <?php esc_html_e("Select categories to show in portfolio items.",'redart');?> </p>
						  </div>
					  </div><!-- Categories End-->                
	...
	if( !function_exists('redart_page_meta_save') ) {
		function redart_page_meta_save($post_id){
			...
			if ( (key_exists('post_type', $_POST)) && ('page' == $_POST['post_type']) ) :
				...
				elseif( "tpl-portfolio.php" == $pagetemplate ):
					...
					$settings['ajax-loadmore'] = isset ( $_POST['dttheme-portfolio-ajax-loadmore'] ) ? $_POST['dttheme-portfolio-ajax-loadmore'] : "";
