<?php
	#Post Meta Box
	add_action("add_meta_boxes", "redart_post_metabox");
	add_action('save_post','redart_post_meta_save');

	if( !function_exists('redart_post_metabox') ) {
		function redart_post_metabox(){
			add_meta_box("post-template-meta-container", esc_html__('Post Options', 'redart'), "redart_post_settings","post", "normal", "default");
			add_meta_box("post-format-meta-container",esc_html__('Post Format Options', 'redart'),"redart_post_format_settings","post","normal","default");
		}
	}

	if( !function_exists('redart_post_settings') ) {
		function redart_post_settings($args){
			global $post;
			...
			<div id="page-layout" class="custom-box">
				<div class="column one-sixth">                        
					<label><?php esc_html_e('Layout', 'redart');?> </label>
				</div>
				<div class="column five-sixth last">  
					...
					<p class="note"> <?php esc_html_e("You can choose a perfect layout for your post", 'redart');?> </p>
				</div>
			</div><!-- Layout End-->
			...
			<div class="custom-box">
				<div class="column one-sixth">
					<label><?php esc_html_e('Show Featured Image', 'redart');?></label>
				</div>
				<div class="column five-sixth last">
					...
					<input id="dttheme-post-featured-image" class="hidden" type="checkbox" name="post-featured-image" value="true" <?php echo redart_wp_kses($checked);?>/>
					<p class="note"> <?php esc_html_e('YES! to show featured image', 'redart');?> </p>
				</div>
    ...
    if( !function_exists('redart_post_format_settings') ) {
		function redart_post_format_settings( $args ) {
			global $post;
			$tpl_default_settings = get_post_meta($post->ID,'_dt_post_settings',TRUE);
			$tpl_default_settings = is_array($tpl_default_settings) ? $tpl_default_settings  : array(); ?>
			...
			<div id="dt-post-format-gallery">
				<div class="custom-box">
					<div class="column one-sixth"><label><?php esc_html_e('Image Gallery', 'redart');?> </label></div>
					<div class="column five-sixth last">
						<div class="dt-media-btns-container">
							<a href="#" class="dt-open-media-for-gallery-post button button-primary"><?php esc_html_e( 'Click Here to Add Images', 'redart' );?></a>
						</div>
						<div class="clear"></div>
			...
			<div id="dt-post-format-video-audio">
				<div class="custom-box">
					<div class="column one-sixth"><label><?php esc_html_e('oEmbed URL', 'redart');?> </label></div>
					<div class="column five-sixth last">
						...
						<p class="note"><?php esc_html_e("Enter a URL that is compatible with WP's built-in oEmbed feature. This setting is used for your video and audio post formats.", 'redart');?></p>
					</div>
				</div>
	
				<div class="custom-box">
					<div class="column one-sixth"><label><?php esc_html_e('Self Hosted URL', 'redart');?> </label></div>
					<div class="column five-sixth last">
						...
						<p class="note"><?php esc_html_e("Insert your self hosted video or audio url here.", 'redart');?></p>                    
					</div>
				</div>
			</div><?php
		}
	...
	if( !function_exists('redart_post_meta_save') ) {
		function redart_post_meta_save($post_id){
