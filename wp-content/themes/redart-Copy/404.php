	...
	<div class="center-content-wrapper">
		<div class="center-content"><?php
			...
			elseif( redart_option('pageoptions','enable-404message') ):
				...
				echo '<a class="dt-sc-button small icon-right with-icon rounded-corner type2" target="_blank" href="'.home_url('/').'">'.esc_html__('Back to Home','redart').' <span class="fa fa-home"> </span></a>';
			endif; ?>
        </div>
    </div>
</div>
