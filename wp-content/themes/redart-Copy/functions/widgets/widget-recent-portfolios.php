<?php
class Redart_Portfolio_Widget extends WP_Widget {
	#1.constructor
	function __construct() {
		$widget_options = array("classname"=>'widget_popular_entries', 'description'=>esc_html__('To list out portfolio items', 'redart'));
		parent::__construct(false,REDART_NAME.esc_html__(' Portfolio','redart'),$widget_options);
	}
	...
	function widget($args, $instance) {
		...
		echo "<div class='recent-portfolio-widget'><ul>";
			 ...
			 if($the_query->have_posts()) :
			 	...
			 	echo "<li>".esc_html__('No Portfolio Entries found','redart')."</li>";
			 endif;
			 wp_reset_postdata();
	 	echo "</ul></div>";			 
